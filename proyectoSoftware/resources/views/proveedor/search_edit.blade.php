...
@section('content')
    <div class="container" style="max-width: 800px; margin-top: 30px;">
        <h1 class="text-center" style="color: #007bff; font-weight: bold; margin-bottom: 30px;">Buscar Proveedor para Editar</h1>

        <form action="{{route('proveedor_get')}}" method="GET" style="display: flex; flex-direction: column; gap: 20px;">

            {{ csrf_field() }}

            <label for="rucProveedor" style="font-weight: bold; color: #555;">RUC:</label>
